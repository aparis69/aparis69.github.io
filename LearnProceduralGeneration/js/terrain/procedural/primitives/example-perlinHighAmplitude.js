...
function mountainPrimitive(x, y) {
	return Math.abs(fBm(x, y, state.perlin, stateGUI.Amplitude, stateGUI.Frequency, 5, 1));
}
...
function initGUI() {
	...
	// Controls
	gui.add(stateGUI, 'Frequency', 0.5, 5).onChange(value => { initTerrain(); });
